...
issue](https://github.com/cisagov/action-lineage/issues) in
...
request](https://github.com/cisagov/action-lineage/pulls),
...
```console
cd action-lineage
pyenv virtualenv <python_version_to_use> action-lineage
pyenv local action-lineage
